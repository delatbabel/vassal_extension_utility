...
- [docs/tools/README.md](docs/tools/README.md) — **reference guide to the command-line tools**: one page per script with a synopsis, an option table, worked examples and an interactive data-flow diagram
- [docs/architecture/architecture.html](docs/architecture/architecture.html) — interactive runtime architecture diagram of the Java application (components, primary Move/Copy path, external dependencies, process and filesystem boundaries)
